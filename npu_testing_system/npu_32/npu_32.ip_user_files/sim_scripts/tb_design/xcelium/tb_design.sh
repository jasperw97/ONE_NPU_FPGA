...
#
# Script generated by Vivado on Sun Jun 21 10:57:11 CST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_design.sh
...
#
# Usage        : tb_design.sh
#                tb_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_design.sh [-reset_run]
#                tb_design.sh [-reset_log]
#                tb_design.sh [-help]
#
...
#                script (type 'tb_design.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_19 -libname xlconstant_v1_1_9 -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_16 -libname smartconnect_v1_0 -libname axi_register_slice_v2_1_33 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_19 xlconstant_v1_1_9 lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 smartconnect_v1_0 axi_register_slice_v2_1_33)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "tb_design.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/0127/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/0127/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/0127/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/0127/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/0127/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../bd/tb_design/ip/tb_design_axi_vip_0_0/sim/tb_design_axi_vip_0_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_19 $xmvlog_opts -sv +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/0127/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconstant_v1_1_9 $xmvlog_opts +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/0127/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/0127/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_register_slice_v2_1_33 $xmvlog_opts +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/ec67/hdl" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/f0b6/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/0127/hdl/verilog" +incdir+"../../../../adder.gen/sources_1/bd/tb_design/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tb_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tb_design -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jasper/npu_testing_system/adder/adder.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tb_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_design.sh [-help]\n\
Usage: tb_design.sh [-step]\n\
Usage: tb_design.sh [-lib_map_path]\n\
Usage: tb_design.sh [-reset_run]\n\
Usage: tb_design.sh [-reset_log]\n\
Usage: tb_design.sh [-keep_index]\n\
Usage: tb_design.sh [-noclean_files]\n\n\
