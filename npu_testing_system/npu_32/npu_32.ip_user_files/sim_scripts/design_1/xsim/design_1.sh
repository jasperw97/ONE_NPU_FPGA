...
export RDI_DATADIR="/opt/Xilinx/2025.2/data"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/opt/Xilinx/2025.2/data/xsim"
  fi
