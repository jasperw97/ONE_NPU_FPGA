...
//--------------------------------------------------------------------------------
//Command: generate_target bd_be6b.bd
//Design : bd_be6b
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_be6b,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_be6b,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "design_1_ddr4_0_2_microblaze_mcs.hwdef" *) 
module bd_be6b
   (Clk,
    IO_addr_strobe,
    IO_address,
    ...
    TRACE_reg_write,
    TRACE_valid_instr);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN bd_be6b_Clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_be6b lmb_bram_I bd_be6b second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  bd_be6b_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_be6b_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_be6b_iomodule_0_0 iomodule_0
       (.Clk(Clk),
  ...
  bd_be6b_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_be6b dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  bd_be6b_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_be6b_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_be6b_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_be6b_second_lmb_bram_I_0 second_lmb_bram_I
