...
(
    ...
    input wire [`INT8_SIZE * LANES - 1:0] input1,
    input wire [`INT8_SIZE * LANES - 1:0] input2,
    ...
    wire signed [`INT8_SIZE-1:0] in1_array [0:LANES-1];
    wire signed [`INT8_SIZE-1:0] in2_array [0:LANES-1];
    ...
    generate
        for(i = 0; i < LANES; i = i + 1) begin : mul_elements
