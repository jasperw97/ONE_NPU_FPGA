...
module SystolicArray_OS_INT8_REQUANT_SRAM #(
    parameter int PE_SIZE = 64,
    ...
    logic [ADDR_BITS-1:0]             output_row_idx_r;
    ...
    always_comb begin
        ...
        case (state)
            ...
            OUT: begin
                if (output_row_idx_r == PE_SIZE - 1 || output_addr_y_i32 == M_r - 1)
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (output_row_idx_r == PE_SIZE - 1 || output_addr_y_i32 == M_r - 1)
                ...
                output_row_idx_r <= output_row_idx_r + 1'b1;
